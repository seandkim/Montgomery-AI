...
# OUTPUT_DIR = "./images/processed/mediapipe"
INPUT_DIR = "./files/sevennation/"
OUTPUT_DIR = INPUT_DIR
IMAGE_FILES = [
    # "./images/raw/hand.png",
    # "./images/raw/guitar.png", # doesn't work
    # "./images/raw/guitar2.png" # doesn't work
    # "guitar3.png"
    "test.png"
]
...
with mp_hands.Hands(
    ...
    for idx, file in enumerate(IMAGE_FILES):
        ...
        # above).
        image = cv2.flip(cv2.imread(f"{INPUT_DIR}/{file}"), 1)
        ...
        cv2.imwrite(f"{OUTPUT_DIR}/{file}", cv2.flip(annotated_image, 1))
